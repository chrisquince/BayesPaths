...
from AssemblyPath.distributions.exponential import exponential_draw
...
class nmf_np:
    ...
    def factorizeV(self, iterations):

       
        for k in range(self.K):
            Wk = self.U[:,k]
            qW = numpy.quantile(Wk, 0.25)
    ...
    def factorizeU(self,iterations):
