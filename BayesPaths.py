...
def main(argv):
    ...
    assGraph.update(100, True,logFile=args.outFileStub + "_log.txt",drop_strain=None,relax_path=True)
    ...
    assGraph.getMaximalUnitigs(args.outFileStub + "Haplo_" + str(assGraph.G) + ".fa", strain_drop_elbo, relax_path=True)
